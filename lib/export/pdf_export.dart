...
/// Druckfertiger A4-Monatsbericht mit Briefkopf, Tabelle, Summen und
/// Unterschriftszeilen. Der Name im Briefkopf ist der Lizenzname – eine
/// separate „Mitarbeiter"-Zeile gibt es in der Einzelnutzer-Version nicht.
Future<Uint8List> pdfExport({
  ...
  doc.addPage(pw.MultiPage(
    ...
    build: (ctx) => [
      ...
      // Links unterschreibt der Nutzer selbst; rechts kann der Auftraggeber
      // gegenzeichnen (z.B. als Nachweis für die Abrechnung).
      pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
        pw.Column(children: [
          pw.Container(width: 180, height: 1, color: PdfColors.grey700),
          pw.Text('Datum, Unterschrift',
              style: const pw.TextStyle(fontSize: 8)),
        ]),
        pw.Column(children: [
          pw.Container(width: 180, height: 1, color: PdfColors.grey700),
          pw.Text('Datum, Unterschrift Auftraggeber',
              style: const pw.TextStyle(fontSize: 8)),
        ]),
      ]),
    ],
